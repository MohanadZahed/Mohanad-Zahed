...
Der Fokus lag hierbei meist auf Modularisierung, Micro-Frontends und der Migration von Legacy-Systemen zu Headless-  
Plattformen. Dank Fullstack-Kenntnissen kommuniziere ich auf Augenhöhe mit Backend-Teams und gestalte mit dem  
CI/CD durchgängige Workflows vom Commit bis zum Release. Ergänzt wird mein Profil durch fundierte Kenntnisse in KI-  
gestützter Entwicklung, mit denen ich die Projektumsetzung effizienter gestalte. Meine langjährige Erfahrung mit agilen  
Methoden und Scrum bringt zudem ein solides Verständnis für Prozesse, Qualität und agile Lieferung mit sich.
...
Postman | Kafka  
METHODEN Agile Methodiken & Praktiken | Agile Softwareentwicklung | Barrierefreiheit | BDD | Code  
Analyse | Code Review Techniken | Micro Frontend Architektur | Feature Toggles | Content  
Management Architektur | Design Pattern | Designguide-Erstellung | Continues Integration |  
Shift left | Unit Test | E-2-E-Tests | Systemtests | Kanban | Monolithische Software-  
Architektur | MVC | Trunk-Entwicklung | OOP | Refactoring | Atom Design | Release-  
Management | Scrum | SEO | Single Page Application | SSR | Software-Architektur |  
Softwaremodularisier-ung | SOLID-Prinzipien | Technische Projektleitung | Usability | W3C  
Standards | Webservices Architekturkonzepte  
SOFTSKILLS Anpassungsfähigkeit | Continuous learning | Ausgeprägte Organisationsfähigkeiten | Entsch-  
eidungskompetenz | Fachliche Teamführung | Flexibilität | Kritikfähigkeit | Kundenorientier-  
ung | Lösungsorientiert | Strategisches Denken | Teamgeist | Unterweisung / Know-how  
Transfer | Verantwortungsbewusstsein | Zeitmanagement | CoachingZ E R T I F I K A T E  
...
Team- /Projektgröße 12/80  
Umfeld Scrum | Agile | Spring boot | Java | Maven | Micro Services | Kafka | Oracle SQL | Docker |  
...
STEP (Stammdatenerfassungs- und pflegesystem) ist das zentrale Stammdatensystem der  
Bundesagentur für Arbeit (BA). Das beinhaltet die Erfassung und Pflege von Betriebs- und  
Personendaten. STEP fungiert als zentrales System für fast alle BA-IT-Verfahren, die Stammdaten zu  
...
zur Sicherstellung der datenschutzrechtlichen und datensicherheitsrechtlichen Auflagen mit  
einbezogen, sowie Auflagen zur Barrierefreiheit.  
AUFGABEN IM PROJEKT  
...
▪ Durchführung von Testanalysen sowie Erstellung und Wartung von manuellen Komponententests,  
System- und End-to-End-Tests  
▪ Implementierung neuer REST-Endpoints sowie Anpassung und Weiterentwicklung bestehender  
Schnittstellen und Kafka-basierter Event-Prozesse  
...
Senior Frontend Entwickler Medienwerft GmbH | Hamburg | August 2019 – Juni 2025  
PROJEKTE:  
Frontend Berater | Modernisierung des B2B-Versicherungskundenportals | 03/2024 – 06/2025  
Kunde Sozialversicherung für Landwirtschaft, Forsten und Gartenbau, Kassel  
...
angepasst wurden, um RESTful API-Endpunkte gemäß dem OpenAPI-Standard bereitzustellen. Gearbeitet wurde  
nach dem Scrum-Framework in einmonatigen Sprints.  
Langfristiges Ziel des Projekts war es, schrittweise von SAP Commerce (Hybris) auf eine moderne, JHipster-  
basierte Lösung zu migrieren – insbesondere weil SAP Commerce in diesem Kontext primär als technologische  
Basis diente, ohne E-Commerce-Funktionalitäten zu nutzen. Durch die Ablösung sollte zudem eine signifikante  
Reduzierung der Lizenzkosten erreicht werden.  
Die Umstrukturierung diente dazu, die Wartbarkeit zu verbessern, die Unabhängigkeit von Frontend und Backend  
zu fördern und die Plattform zukunftssicher für Erweiterungen und Integrationen zu gestalten.  
AUFGABEN IM PROJEKT  
▪ Migration der Angular-Anwendung zu einem Monorepo mit Nx zur Strukturierung und Nutzung  
gemeinsamer Bibliotheken über mehrere Applikationen.  
...
▪ Enge Zusammenarbeit mit dem Backend-Team zur Integration und Nutzung von OpenAPI-basierten REST-  
Schnittstellen  
...
dem Ziel, eine schnellere, benutzerfreundlichere und visuell ansprechendere Lösung bereitzustellen. Im  
Mittelpunkt standen die Optimierung der Performance, ein neues responsives Design sowie die Erweiterung um  
Funktionen, die Nutzer:innen einen klareren Überblick über persönliche Daten wie Vertragsinformationen,  
Nutzungsverhalten und Kontodetails ermöglichen.  
Das mobilcom-debitel eCare-Benutzer-Dashboard wurde auf Basis der bestehenden Angular-Architektur  
vollständig neu entwickelt. Das Projekt war als Nx Monorepo organisiert und nutzte durchgängig GraphQL für die  
Kommunikation mit dem Backend.  
Darüber hinaus wurde das Dashboard funktional erweitert, um gezielt personalisierte Inhalte wie  
Marketingkampagnen, Produktempfehlungen und Sonderaktionen dynamisch und nutzerorientiert darzustellen.  
Die Entwicklung erfolgte in einem agilen Scrum-Setup in enger Zusammenarbeit mit UX-Designern, Frontend-  
Team sowie Stakeholdern aus dem Marketing. Der technische Fokus lag auf einer sauberen und wartbaren  
Architektur, hoher Wiederverwendbarkeit der Komponenten und Skalierbarkeit für zukünftige Anforderungen.  
AUFGABEN IM PROJEKT  
▪ Implementierung der neuen eCare-Dashboard-Seite zur Anzeige von Verträgen, Datenverbrauch,  
Rechnungen, Marketinginhalten und weiteren Informationen  
...
▪ Einbindung des neuen Dashboards in die bestehende Angular-Anwendung in Abstimmung mit dem  
Entwicklungsteam  
...
Ziel des Projekts war die Entwicklung eines agnostischen Integrations-SDKs, das sich nahtlos in beliebige  
Frontend-Anwendungen einbinden lässt und eine sofort nutzbare Anbindung an die E-Commerce-Plattform  
Emporix bietet. Das SDK wurde technologieunabhängig konzipiert, um maximale Flexibilität und  
Wiederverwendbarkeit zu gewährleisten. Als Grundlage diente das offizielle Integrations-Boilerplate von Alokai zur  
Sicherstellung von Standardisierung und Wartbarkeit.  
AUFGABEN IM PROJEKT  
▪ Entwicklung von TypeScript-Modulen im Integrations-SDK zur Abwicklung von Login-Prozessen sowie  
Produkt- und Produktlistenabfragen.  
...
▪ Sicherstellung der Framework-Agnostik und der einfachen Integration in verschiedene Frontend-  
Anwendungen.  
Senior Frontend-Entwickler | Performance-Optimierung des Onlineshops | 07/2023 – 09/2023  
Kunde HABA FAMILYGROUP, Bad Rodach  
Branche Spielwarenhersteller  
Team- /Projektgröße 2/8  
Umfeld Spring boot | Java | E-Commerce | CMS | SAP Hybris | SAP Commerce | SAP Composable  
...
▪ Zusammenarbeit mit dem Entwicklungsteam und Stakeholdern zur Sicherstellung einer reibungslosen  
Umstellung ohne Funktionsverlust  
Frontend-Projektlead | Entwicklung und Migration moderner Onlineshops mit SAP Commerce Cloud und  
Composable Storefront | 10/2022 – 07/2023  
Kunde Otto’s AG Und Sherpa Outdoor, Zürich  
Branche Einzelhandel  
Team- /Projektgröße 12/20  
Umfeld Scrum | Agile | Migration | OpenAPI | E-Commerce | CMS | Spring boot | Java | SAP Hybris |  
...
▪ Entwicklung von GUI-Komponenten unter besonderer Berücksichtigung von Usability und Performance  
▪ Aufbau und Konfiguration der Angular-Pipeline zur Unterstützung von Continuous Integration  
Senior Frontend-Entwickler | B2B Onlineshops für Landgard und Ordertage | 05/2021 – 09/2022  
Kunde Landgard eG, Staelen-Herongen  
Branche Gartenbau & Großhandel  
Team- /Projektgröße 6/10  
...
Frontend-Entwickler | Entwicklung von 13 Onlineshops für DAW Group | 01/2020 – 12/2020  
Kunde DAW SE, Ober-Ramstadt  
Branche Bauchemie / Farben- und Lackindustrie  
...
▪ Implementierung von Oberflächenkomponenten basierend auf dem neuen Styleguide und in enger  
Zusammenarbeit mit dem Design-Team.  
Frontend-Entwickler | Dachdecker-Onlineshop | 08/2019 – 01/2020  
Kunde Dachdecker-Einkauf Süd eG, Mannheim  
...
▪ Abstimmung mit dem Product Owner zur Priorisierung von Anforderungen Implementierung von  
...
Bildern, PDFs und Texten  
▪ Entwicklung einer CMS-Webanwendung mit Angular 6 zur Verwaltung der Inhalte durch autorisierte Nutzer  
▪ Gestaltung einer benutzerfreundlichen UI für die Inhaltsanzeige und \-pflege  
Backend  
▪ Entwicklung von RESTful Webservices mit JAX-RS zur Bereitstellung von Inhalten für App und CMS  
▪ Anbindung und Verwaltung der Inhalte über eine Microsoft SQL Server-Datenbank  
▪ Sicherstellung der Datenkonsistenz und Performance im Zusammenspiel mit Frontend und Datenbank  
...
▪ Integration der Barcode-Scan-Funktion zur Erfassung von Produktdaten im Lager  
▪ Darstellung produktrelevanter Informationen  
▪ Implementierung der digitalen Unterschrift zur Bestätigung der Aufträge  
Backend  
▪ Entwicklung von RESTful Webservices mit JAX-RS zur Anbindung an das SAP ERP-System  
