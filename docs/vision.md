...
| 0.296–0.392     | **Knowledge**         | n/a (orbit silent)                | n/a                                       | yoga avatar fades in, spins π → 0, continuous gentle float; five math-pattern SVGs form a cursor-reactive arc behind him                                                | static — drives `knowledgeProgress` |
