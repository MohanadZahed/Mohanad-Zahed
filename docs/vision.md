...
| 0.74–end | Notebook **stays pinned full-size** showing its black terminal screen — it no longer lifts off the top (the old `HANDOFF` phase was removed). It holds here until Skills, overlapping the tail, emerges from the screen and zooms out to cover it — see Skills storyboard. |
