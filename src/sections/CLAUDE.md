...
| 0.296–0.392 | Knowledge | 3D canvas hosts second yoga avatar + 5 cursor-reactive math-pattern SVGs in an upper-ellipse arc behind him (`MathBackdrop`); section drives its own choreography via `useScrollStore.knowledgeProgress` |
